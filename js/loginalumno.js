$(document).ready(function () {
  ...
  var ref= firebaseRef.ref("AlumnoEsc/")
      ...
      if(user != null){
        ...
        ref.on("child_added",function(data){
          ...
          if (email_id== datos.CorreoElectronico) {
            ...
            document.getElementById("TipoUsuario").innerHTML = datos.TipoUsuario;
...
function cambio(){
  $('#Calificacion').on('click', function(){
    $('#content').attr('src', 'alumno/Calificacion.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
    document.getElementById("content").style.display ="block";
  });

  $('#Contprof').on('click', function(){
    $('#content').attr('src', 'alumno/Profesores.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
    document.getElementById("content").style.display ="block";
  });
  ...
  $('#Modulos').on('click', function(){
    $('#content').attr('src', 'alumno/Modulos.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
    document.getElementById("content").style.display ="block";
  });
