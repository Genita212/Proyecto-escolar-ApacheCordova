$(document).ready(function () {
    ...
    var ref= firebaseRef.ref("ProfesorEsc/");
      ...
      if(user != null){
        ...
        ref.on("child_added",function(data){
          ...
          if (email_id== datos.CorreoElectronico) {
            ...
            document.getElementById("NumEmpleadoProfesor").innerHTML = datos.NumEmpleado;
...
function cambio(){
  $('#alumno').on('click', function(){
    $('#content').attr('src', 'profesor/tablalumno.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
  ...
  $('#grupo').on('click', function(){   
    $('#content').attr('src', 'profesor/tablagrupo.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
    document.getElementById("content").style.display ="block";
  });
  ...
  $('#modulo').on('click', function(){
    $('#content').attr('src', 'profesor/tablamodulo.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
    document.getElementById("content").style.display ="block";
  });

  $('#edical').on('click', function(){
    $('#content').attr('src', 'profesor/tablacalificaciones.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
    document.getElementById("content").style.display ="block";
  });
  ...
  $('#calificacion').on('click', function(){
    $('#content').attr('src', 'profesor/calificaciones.html');
    document.getElementById("tablilla").style.display = "none"
    document.getElementById("informacion").style.display = "none"
    document.getElementById("content").style.display ="block";
  });
