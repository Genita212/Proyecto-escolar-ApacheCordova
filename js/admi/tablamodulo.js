...
var coleccionArchivos = db.ref().child("ModuloEsc");
     
var dataSet = [];//array para guardar los valores de los campos inputs del form
var table = $('#tablamodulo').DataTable({
            pageLength : 5,
...
coleccionArchivos.on("child_added", datos => {        
    dataSet = [datos.key, datos.child("Clave_modulo").val(), datos.child("Nombre_modulo").val()];
...
$('form').submit(function(e){                         
    ...
    data = {Clave_modulo:codigo, Nombre_modulo:modulo};             
    actualizacionData = {};
...
$("#tablamodulo").on("click", ".btnEditar", function() {    
    filaEditada = table.row($(this).parents('tr'));           
    let fila = $('#tablamodulo').dataTable().fnGetData($(this).closest('tr'));               
    let id = fila[0];
    console.log(id);
...
$("#tablamodulo").on("click", ".btnBorrar", function() {   
    filaEliminada = $(this);
    Swal.fire({
