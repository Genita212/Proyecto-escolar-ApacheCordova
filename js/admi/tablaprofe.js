...
var table = $('#tablaprofe').DataTable({
            pageLength : 5,
...
$("#tablaprofe").on("click", ".btnEditar", function() {    
    filaEditada = table.row($(this).parents('tr'));           
    let fila = $('#tablaprofe').dataTable().fnGetData($(this).closest('tr'));               
    let id = fila[0];
    console.log(id);
...
$("#tablaprofe").on("click", ".btnBorrar", function() {   
    filaEliminada = $(this);
    Swal.fire({
